...
if __name__ == '__main__':
    ...
    if time: 
        ...
        with open(cfg.time,'a') as csvfile:
            ...
            csvwriter.writerow([t,'FlowSampling',cfg.filenames[findex],'start'])
    ...
    if time:
        ...
        t = epochtime.time()
        print('\n(Flowsampling, runtime: %.3f' % (end-start),'seconds)\n')
        with open(cfg.time,'a') as csvfile: # write timestamp to csv
            csvwriter = csv.writer(csvfile, delimiter=",")
            csvwriter.writerow([t,'FlowSampling',cfg.filenames[findex],'end'])
