...
# https://raw.githubusercontent.com/CN-TU/Datasets-preprocessing/master/CIC-IDS-2017/labeling/labeling.py
...
# usage for CSV named allPCAPS_unlabeled.csv: python Labeling.py "allPCAPS" 5tuple
# sys.argv[1] should be a string with the name of the "string"_unlabeled.csv
# sys.argv[2] is the mode, e.g. 5tuple
...
# check https://docs.python.org/3.3/library/datetime.html
